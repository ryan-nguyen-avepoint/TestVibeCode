      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8 animate-fade-in">
          ...
          <h1 className="text-3xl font-bold t-text">
            Vibe<span className="text-gradient">Ryan</span>
          </h1>
        ...
        <div className="glass-card p-8 animate-slide-up">
          <h2 className="text-xl font-semibold t-text mb-1">Welcome back</h2>
          <p className="t-text-m text-sm mb-6">Sign in to continue your conversations</p>
